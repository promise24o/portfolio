...
import {isSmallScreen} from "../utils/libs"
...
const timelineSvg = useRef<SVGSVGElement>(null) as MutableRefObject<SVGSVGElement>;
const svgContainer = useRef<HTMLDivElement>(null) as MutableRefObject<HTMLDivElement>;
const screenContainer = useRef<HTMLDivElement>(null) as MutableRefObject<HTMLDivElement>;
  ...
  const renderSectionTitle = (): React.ReactNode => (
    <div className="flex flex-col">
      ...
      <h2 className="text-2xl md:max-w-2xl w-full seq mt-2">
        A quick recap of notable work history
      </h2>
    </div>
  );
  ...
  return (
    <section
      className="w-full relative section-container flex flex-col justify-center pt-20 pl-10 pr-10 bg-[#0E1016] bg-cover bg-center"
    >
      {renderSectionTitle()}
